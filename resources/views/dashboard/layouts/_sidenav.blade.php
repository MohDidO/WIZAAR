<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ Request::is('dashboard/pelajaran') ? 'active':''}}">
        <a href="/dashboard/pelajaran" target="_blank" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
            ...
            <span class="sidebar-text">Input</span>
          </span>
          <span>
            <span class="badge badge-sm bg-secondary ms-1 text-gray-800">Premium</span>
          </span>
        </a>
      </li>
